...
def FeatureExtraction(image):
    ...
    """ Feature 7-10: Horizontal Segmentation features: Basic """
    hori_slice_height = image.shape[0] // 4
    hori_slice_counts = []
    for i in range(4):
    ...
    """ Feature 10-14: Vertical Segmentation Features: Basic """
    vert_slice_height = image.shape[1] // 4
    vert_slice_counts = []
    for i in range(4):
